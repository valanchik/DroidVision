...
namespace Darknet
{
    public class YoloWrapperTiny : IDisposable
    {
        private const string YoloLibraryName = "yolo_cpp_dll_gpu2.dll";
        ...
        public YoloWrapperTiny(string configurationFilename, string weightsFilename, int gpu)
        {
